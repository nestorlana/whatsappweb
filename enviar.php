...
<form action="enviar_executa.php" method="post">
  <p><strong>Selecione o país:</strong> 
    <select name="cod_pais" required="yes" class="form-control">
    ...
    <option data-countryCode="ZW" value="263">Zimbabwe (+263)</option>
          ...
          <br>
          <strong>Código de Área / Região:</strong> 

<input type="number" name="cod_ddd" required="yes" autofocus class="form-control" placeholder="Ex: 61 (DDD ou código de região)">

          <br>
          <strong>Número do telefone:</strong> 
          <input type="number" name="nr_telefone" required="yes" autofocus class="form-control" placeholder="Ex: 999999999 (Funciona com 9 ou 8 dígitos)">
          <br>
          <input type="submit" value="Preparar mensagem de WhatsApp" class="form-control btn btn-success">
        </p>
        </form>
